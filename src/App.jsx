...
const App = () => {
  ...
  const handleJsonInputChange = (event) => {
    ...
    // try and catch block to handle invalid JSON
    try {
      const parsedPreview = JSON.parse(value);
  ...
  return (
    <div className="flex m-5 gap-5 md:flex-row flex-col">
      <div className="flex-1">
        <h2 className="text-2xl font-bold mb-4 text-center">JSON Schema Editor</h2>
        <textarea
          className="w-full h-full p-2 border rounded resize-none shadow-md"
          rows='20'
